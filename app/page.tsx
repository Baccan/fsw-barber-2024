    ...
    <div>
      ...
      <div className="p-5">
        ...
        <div className="mt-6 flex gap-2 overflow-x-scroll [&::-webkit-scrollbar]:hidden">
          ...
          <Button className="gap-2" variant="secondary">
            <Image src="/barba.svg" alt="Barba" width={14} height={16} />
            Barba
          </Button>
          ...
          <Button className="gap-2" variant="secondary">
            <FootprintsIcon width={14} height={16} />
            Pézinho
          </Button>

          <Button className="gap-2" variant="secondary">
            <EyeIcon width={14} height={16} />
            Sobrançelha
          </Button>
        </div>
        ...
        <Card>
          <CardContent className="px-5 py-6">
            <p className="text-sm text-gray-400">
              @ 2024 Copyrigth <span className="font-bold">FSW Barber</span>
            </p>
          </CardContent>
        </Card>
      </footer>
